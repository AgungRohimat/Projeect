    ...
    <a  href="login.php"  class="btn btn-outline-success my-2 my-sm-0" type="submit">Keluar</a>
        ...
        <div class="card">
            ...
            <?php
                ...
                foreach ($customer->edit($_GET['kd_customer']) as $data) {
                  $kd = $data['kd_customer'];
                    $nama = $data['nama'];
                    $almat = $data['alamat'];
            ...
            ?>
            <form action="../customer/proses.php" method="post">
                <input type="hidden" name="aksi" value="update">
                <input type="hidden" name="kd_customer" value="<?php echo $kd; ?>">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Id</label> 
                        <input type="text" class="form-control" name="kd_customer" value="<?php echo $kd; ?>">
                    </div>
                    <div class="form-group">
