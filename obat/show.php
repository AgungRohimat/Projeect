            ...
            <form action="" method="">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="no" value="<?php echo $no; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jenis Obat</label> 
                        <input type="text" class="form-control" name="jenis" value="<?php echo $jenis; ?>" disabled>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Bentuk Obat</label> 
                        <input type="text" class="form-control" name="bentuk" value="<?php echo $bentuk; ?>" disabled>
                    </div>
                    <div class="form-group">
